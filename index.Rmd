...
server <- function(input, output, session) {
  ...
  facet_wrap(~group,scales='free',as.table = T,ncol=1)+theme(axis.text.x = element_text(angle = 90),text = element_text(size = 8))
  })
...
<!--   # ha_column = reactive({HeatmapAnnotation( -->
<!--   #     heat_data <-heat_df(), -->
<!--   #     gene_seq = heat_data$wt_aa, -->
<!--   #     mutation_rate = heat_data$mut_percent, -->
<!--   # -->
<!--   #     col = #A list of named vectors were names = vector values and value = color. -->
<!--   #       list( -->
<!--   #       gene_seq = aa_cols, -->
...
<!--   output$plot <-shiny::renderPlot({print(p_heat()) })#, height = 4000)#height = function(){he()*input$height})# -->
