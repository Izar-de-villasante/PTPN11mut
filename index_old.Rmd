...
In this interactiove plot the fraction of each aminoacid conversion can be explored. Fell free to swap between batches and reordering the sequence either by original protein sequence or by alphabetical order of the aminoacids. 
